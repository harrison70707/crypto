...
contract MappingEx{
    ...
    function getDepositsNum(address _from, uint _numDeposit) public view returns(Transaction memory) {
    ...
    function withdrawMoney(address payable _to, uint _amount) public {
        ...
        // create a Transaction and store it using the correct names
